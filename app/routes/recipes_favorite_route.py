...
from app.controllers.favorite_recipes import favorite_recipe, get_favorite_recipes, delete_favorite_recipe
...
bp_recipes_favorite.get("/favorites")(get_favorite_recipes)
